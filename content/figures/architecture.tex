\begin{figure}
  ...
  \caption[System architecture]{The \emph{Telemetry} component instruments the \emph{RxJS program} (right). The \emph{RxJS Debugger Extension} runs inside of the vscode process. The two components communicate with each other by reusing the CDP communication channel established by \emph{js-debug}.}
